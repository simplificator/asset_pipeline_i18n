...
=== No proper i18n in development mode  
  
This gem is intended for compile translated assets for production environment.
Unfortunately it doesn not provide proper translations when running in development environment due to assets caching.
